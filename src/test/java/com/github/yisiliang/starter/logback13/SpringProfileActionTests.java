...
class SpringProfileActionTests {
	...
	private final SpringProfileAction action = new SpringProfileAction();

	private final Context context = new ContextBase();

	private final SaxEventInterpretationContext interpretationContext = new SaxEventInterpretationContext(this.context, null);
